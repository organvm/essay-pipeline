...
**Org:** `organvm-v-logos` | **Repo:** `essay-pipeline`

### Edges
- **Produces** → `ORGAN-V`: essay-topic-suggestions
- **Produces** → `ORGAN-V`: sprint-narrative-draft
- **Produces** → `ORGAN-V`: essays-index
- **Consumes** ← `{'organ': 'ORGAN-V', 'repo': 'public-process'}`: essay-markdown
- **Consumes** ← `{'organ': 'ALL', 'repo': '*'}`: system-activity
- **Consumes** ← `{'organ': 'ORGAN-III'}`: process-documentation
- **Consumes** ← `{'organ': 'ORGAN-I'}`: research-discourse
- **Consumes** ← `{'organ': 'ORGAN-IV'}`: governance-documentation

### Siblings in Public Process
`public-process`, `.github`, `analytics-engine`, `editorial-standards`, `reading-observatory`
